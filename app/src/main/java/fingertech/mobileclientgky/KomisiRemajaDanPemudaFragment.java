 ...
 */
public class KomisiRemajaDanPemudaFragment extends Fragment {
...
//    private JSONArray komisiRemajaSaved
    ...
    public static KomisiRemajaDanPemudaFragment newInstance(String param1, String param2) {
        KomisiRemajaDanPemudaFragment fragment = new KomisiRemajaDanPemudaFragment();
    ...
    public KomisiRemajaDanPemudaFragment() {}
...
//            kppkSaved = savedInstanceState.getStringArrayList("kppkSaved");
            ...
            if (arrIsiKomisiRemaja != null){
                ...
                generateKontenUI(arrIsiKomisiRemaja);
            }
            else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_komisi_remaja_dan_pemuda, container, false);
    ...
    private void setUpLayout() {
        myLinearLayout = (LinearLayout)rootView.findViewById(R.id.container_komisiRemajaDanPemuda);
        imageLayout = (LinearLayout)rootView.findViewById(R.id.container_komisiRemajaDanPemuda_image);
    ...
    private void generateKontenUI (JSONArray arrIsi) {
        ...
        if (arrIsi != null) {
            ...
            try {
                ...
                ImageView GambarIV = (ImageView) rootView.findViewById(R.id.image_komisiRemajaDanPemuda);
    ...
    class Viewer extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            if (arrData.length() == 0 && isNetworkAvailable()){
                Toast.makeText(getActivity().getApplicationContext(), "Tidak ada jadwal komisi Remaja dan Pemuda", Toast.LENGTH_SHORT).show();
            }
