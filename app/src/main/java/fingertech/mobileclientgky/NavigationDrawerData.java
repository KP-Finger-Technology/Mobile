...
public class NavigationDrawerData {
    ...
    public static String[] pembinaanArray = {"Katekisasi", "Pre-marital", "Renungan Gema", "Rekaman Khotbah", "Permohonan Doa", "KPPK", "Lirik Lagu Rohani", "Pengakuan Iman", "Kolportase", "Jadwal Pelayanan"};
