...
public class DiakoniaDanOikumeneFragment extends Fragment {
    ...
    private JSONArray diakoniaSaved;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (diakoniaSaved != null) {
                // Returning from backstack, data is fine, do nothing
                generateKontenUI(diakoniaSaved);
            }
            else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_diakonia_dan_oikumene, container, false);
        return rootView;
    }
    ...
    class Viewer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            HttpGet request = new HttpGet(Controller.url + "view_pelayanan.php?id="+idDiakonia);
