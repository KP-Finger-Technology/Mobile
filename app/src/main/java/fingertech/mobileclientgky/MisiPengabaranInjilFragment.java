...
public class MisiPengabaranInjilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_misi_pengabaran_injil, container, false);
        return rootView;
    }
    ...
    class Viewer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            HttpGet request = new HttpGet(Controller.url + "view_pelayanan.php?id="+idMisi);
